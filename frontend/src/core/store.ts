...
function getDirectorPlayheadsAtFrame(
  ...
  return Object.fromEntries(
    directors.map((director) => {
      ...
      return [director.id, getDirectorLocalFrame(director, frame)];
    }),
  );
}

function getDefaultDirectorDirections(directors: TimelineDirector[]): Record<string, 1 | -1> {
  return Object.fromEntries(directors.map((director) => [director.id, 1]));
}
    ...
    (set, get) => ({
      ...
      setTemplate: (template) => {
        ...
        set({
          ...
          timelineDirectorDirections: getDefaultDirectorDirections(normalizedTimeline.directors),
      ...
      timelineDirectorDirections: getDefaultDirectorDirections(defaultTemplate.timeline.directors),
      ...
      setTimelinePlayhead: (frame) =>
        set((s) => {
          ...
          const timelineTags = f === 0 ? {} : s.timelineTags;
          ...
          return {
            ...
            timelineDirectorDirections: getDefaultDirectorDirections(timeline.directors),
      ...
      advanceTimeline: (deltaFrames) =>
        set((s) => {
          ...
          const playback = stepTimelinePlayback(timeline, prevGlobalFrame, tentativeFrame, {
            ...
            directorDirections: s.timelineDirectorDirections,
            directorActive: {
          ...
          return {
            ...
            timelineDirectorDirections: playback.state.directorDirections ?? getDefaultDirectorDirections(timeline.directors),
            timelineDirectorActive: playback.state.directorActive,
            timelineDirectorStopped: playback.state.directorStopped,
            timelineTags: playback.state.tags,
            ...
            template: {
              ...
              timeline: {
                ...
                actions: timeline.actions.map((action) => {
                  ...
                  const command = patch.command ?? action.command;
                  ...
                  return {
                    ...
                    frame: patch.frame !== undefined
                      ...
                      : action.frame,
                    command,
                    targetDirectorId: isSetTag
                      ? null
                      : patch.targetDirectorId && validDirectorIds.has(patch.targetDirectorId)
                        ? patch.targetDirectorId
                        : patch.targetDirectorId === null
                          ? null
                          : action.targetDirectorId,
                    tag: isSetTag
                      ? (patch.tag ?? action.tag ?? 'Stop')
                      : null,
                  };
                }),
              },
      ...
      addTimelineDirector: () =>
        set((s) => {
          ...
          return {
            ...
            timelineDirectorDirections: {
              ...s.timelineDirectorDirections,
              [director.id]: 1,
            },
      ...
      deleteTimelineDirector: (id) =>
        set((s) => {
          ...
          return {
            ...
            timelineDirectorDirections: Object.fromEntries(
              Object.entries(s.timelineDirectorDirections).filter(([directorId]) => directorId !== id),
            ),
      ...
      updateTimelineDirector: (id, patch) =>
        set((s) => {
          ...
          const directors = timeline.directors.map((director) =>
            director.id === id
              ? (() => {
                  const loop = patch.loop ?? director.loop;
                  return {
                    ...director,
                    ...patch,
                    ...
                    loop,
                    swing: loop ? (patch.swing ?? director.swing) : false,
                  };
                })()
              : director,
          );
          return {
            ...
            timelineDirectorDirections: getDefaultDirectorDirections(directors),
